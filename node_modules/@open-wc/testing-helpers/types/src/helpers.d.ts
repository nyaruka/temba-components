 ...
 * @returns {string} Tag name of the registered element
 */
export function oneDefaultPreventedEvent<TEvent extends Event = CustomEvent<any>>(eventTarget: EventTarget, eventName: string, preventDefault: boolean): Promise<TEvent>;
/**
