...
// valid = uploaded attachments that are sent to the server when the user clicks send
...
// invalid = not-uploaded attachments that are not sent to the server when the user clicks send
