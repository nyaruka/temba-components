...
describe('split_by_llm_categorize JSON output verification', () => {
  it('generates JSON matching the exact format from the issue', () => {
    ...
    // Print the result to console for manual verification
    console.log('Generated node structure:');
    ...
    expect(categoryNames).to.include.members(['Flights', 'Hotels', 'Other', 'Failure']);
