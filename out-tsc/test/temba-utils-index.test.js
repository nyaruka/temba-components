...
describe('utils/index', () => {
    ...
    describe('isImageAttachment', () => {
        it('returns true for image attachments', () => {
            ...
            expect(isImageAttachment(attachment)).to.be.true;
        });
        it('returns false for non-image attachments', () => {
            const attachment = { content_type: 'application/pdf' };
            expect(isImageAttachment(attachment)).to.be.false;
        });
    ...
    describe('showModax', () => {
        let originalShowModax;
        beforeEach(() => {
            originalShowModax = window.showModax;
            window.showModax = stub();
        });
        afterEach(() => {
            window.showModax = originalShowModax;
        });
        it('calls window.showModax with title and endpoint', () => {
            showModax('Test Title', '/test/endpoint');
            expect(window.showModax.calledOnceWith('Test Title', '/test/endpoint')).to.be.true;
        });
    });
    describe('debounce', () => {
    ...
    describe('isDate', () => {
        ...
        it('returns false for non-date values', () => {
            ...
            expect(isDate({ replace: () => { } })).to.be.false;
        });
    });
    ...
    describe('isElementVisible', () => {
      ...
      `);
            element = container.querySelector('#testelement');
        });
    ...
    describe('getScrollParent', () => {
      ...
      `);
            child = scrollableParent.querySelector('#child');
        });
    ...
    describe('renderIf', () => {
        ...
        it('renders otherwise clause when predicate is false', () => {
            const result = renderIf(false)(() => html `<span>true</span>`, () => html `<span>false</span>`);
            expect(result.strings).to.exist; // it's a TemplateResult
        });
...
//# sourceMappingURL=temba-utils-index.test.js.map