...
export const getPickerHTML = (attrs = {}) => {
    return `<temba-datepicker ${getAttributes(attrs)}></temba-datepicker>`;
};
export const createPicker = async (def) => {
...
describe('temba-datepicker', () => {
    ...
    it('can be updated via keyboard', async () => {
        const picker = await createPicker(getPickerHTML({ value: '2020-01-20T14:00Z', id: 'picker', time: true }));
