...
const createTemplateEditor = async (def) => {
    const parentNode = document.createElement('div');
    parentNode.setAttribute('style', 'width: 520px;');
    const templateEditor = await fixture(def, { parentNode });
...
describe('TemplateEditor', () => {
    ...
    `);
        ...
        expect(errorMessage).to.equal('This template currently has no approved translations.');
    });
});
//# sourceMappingURL=temba-template-editor.test.js.map