...
export class ImagePicker extends FormElement {
    ...
    firstUpdated(changed) {
        ...
        this.uploadReader.onload = function () {
            picker.launchCroppie(picker.uploadReader.result);
        };
    }
    updated(changed) {
      ...
      >
        ...
        <temba-mask ?show=${this.showCroppie} class="${this.showCroppie ? 'editing' : ''}">
          <div class='croppie'>
            <div class='embed'></div>
            <div class='controls'>
              <temba-icon class="close" size="1" name=${Icon.close} @click=${this.closeCroppie}></temba-icon>
...
__decorate([
    property({ type: String })
], ImagePicker.prototype, "url", void 0);
__decorate([
    property({ type: String })
], ImagePicker.prototype, "shape", void 0);
__decorate([
    property({ type: Boolean, attribute: false })
], ImagePicker.prototype, "showCroppie", void 0);
