...
export class TemplateEditor extends FormElement {
    ...
    renderVariables(component) {
        ...
        if (component.content && component.content.trim().length > 0) {
            parts = ((_a = component.content) === null || _a === void 0 ? void 0 : _a.split(variableRegex)) || [];
        }
        ...
        ></temba-completion>`;
            ...
            variables = Object.values(component.variables).map((variableIndex) => {
                ...
                if (variableSpec.type === 'image' ||
                    ...
                    let value = variableIndex < currVariables.length
                        ? currVariables[variableIndex]
                        : null;
...
TemplateEditor.shadowRootOptions = {
    ...LitElement.shadowRootOptions,
    delegatesFocus: true
};
__decorate([
    property({ type: String })
], TemplateEditor.prototype, "url", void 0);
__decorate([
    property({ type: String })
], TemplateEditor.prototype, "template", void 0);
__decorate([
    property({ type: Object })
], TemplateEditor.prototype, "selectedTemplate", void 0);
__decorate([
    property({ type: Array })
...
], TemplateEditor.prototype, "translating", void 0);
