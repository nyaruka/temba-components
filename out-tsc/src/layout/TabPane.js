...
export class TabPane extends RapidElement {
    ...
    render() {
      ...
      >
        ${this.options.map((tab, index) => html `
            <div
      ...
      <div
        ...
        style="${(activeTab === null || activeTab === void 0 ? void 0 : activeTab.borderColor)
            ? `
            border-top: var(--temba-tabs-border-top, 1px solid ${(activeTab === null || activeTab === void 0 ? void 0 : activeTab.borderColor) || 'var(--color-widget-border)'});

            border-left: var(--temba-tabs-border-left, 1px solid ${(activeTab === null || activeTab === void 0 ? void 0 : activeTab.borderColor) || 'var(--color-widget-border)'});

            border-bottom: var(--temba-tabs-border-bottom, 1px solid ${(activeTab === null || activeTab === void 0 ? void 0 : activeTab.borderColor) || 'var(--color-widget-border)'});

            border-right: var(--temba-tabs-border-right, 1px solid ${(activeTab === null || activeTab === void 0 ? void 0 : activeTab.borderColor) || 'var(--color-widget-border)'});

            `
            : ''} ${(activeTab === null || activeTab === void 0 ? void 0 : activeTab.selectionBackground)
            ? `background:${activeTab === null || activeTab === void 0 ? void 0 : activeTab.selectionBackground};`
            : ``}"
...
], TabPane.prototype, "options", void 0);
