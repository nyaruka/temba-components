...
export class ContactNotepad extends ContactStoreElement {
    constructor() {
        super(...arguments);
        this.dirtyMessage = 'You have unsaved changes to the contact notepad. Are you sure you want to contiunue?';
    }
    static get styles() {
        return css `
      :host {
    ...
    submitChanges() {
        const notepad = this.shadowRoot.querySelector('.notepad');
    ...
    updated(changes) {
        ...
        if (changes.has('data')) {
            this.note =
                ((_a = this.data) === null || _a === void 0 ? void 0 : _a.notes.length) > 0
...
], ContactNotepad.prototype, "note", void 0);
__decorate([
    property({ type: String })
], ContactNotepad.prototype, "dirtyMessage", void 0);
//# sourceMappingURL=ContactNotepad.js.map