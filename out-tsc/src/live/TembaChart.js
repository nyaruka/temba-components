        ...
        if (this.data) {
            ...
            for (const dataset of this.data.datasets) {
                if (!this.showAll &&
                    ...
                    const colorIdx = (datasets.length + this.colorIndex) % backgroundColors.length;
        ...
        if (((_a = this.datasets) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            ...
            if (this.chart) {
                ...
                if (this.horizontal) {
                    ...
                    this.chart.options.scales.y = this.getCategoryAxisConfig();
                }
                else {
                    this.chart.options.scales.x = this.getCategoryAxisConfig();
    ...
    render() {
      ...
      ${this.config && this.data
            ...
            <div
              class="${getClasses({
                'config-toggle': true,
                show: this.showConfig && ((_b = (_a = this.data) === null || _a === void 0 ? void 0 : _a.datasets) === null || _b === void 0 ? void 0 : _b.length) > 1
            })}"
      ...
      <div class=${getClasses({ config: true, show: this.showConfig })}>
        <temba-select
          ...
          options=${JSON.stringify((_c = this.data) === null || _c === void 0 ? void 0 : _c.datasets.map((dataset) => ({
            name: dataset.label,
            value: dataset.label
        })))}
...
], TembaChart.prototype, "chartType", void 0);
__decorate([
    property({ type: Boolean })
], TembaChart.prototype, "horizontal", void 0);
__decorate([
    property({ type: String })
], TembaChart.prototype, "url", void 0);
__decorate([
    property({ type: String })
], TembaChart.prototype, "start", void 0);
__decorate([
    property({ type: String })
], TembaChart.prototype, "end", void 0);
__decorate([
    property({ type: String })
], TembaChart.prototype, "header", void 0);
__decorate([
    property({ type: Boolean })
], TembaChart.prototype, "other", void 0);
__decorate([
    property({ type: Object })
], TembaChart.prototype, "data", void 0);
__decorate([
    state()
], TembaChart.prototype, "datasets", void 0);
__decorate([
...
__decorate([
    property({ type: Boolean })
], TembaChart.prototype, "requireWindow", void 0);
__decorate([
    property({ type: Number })
...
__decorate([
    property({ type: String })
], TembaChart.prototype, "palette", void 0);
__decorate([
    property({ type: Number })
], TembaChart.prototype, "opacity", void 0);
__decorate([
    property({ type: Number })
], TembaChart.prototype, "seriesBorderRadius", void 0);
__decorate([
    property({ type: Number })
