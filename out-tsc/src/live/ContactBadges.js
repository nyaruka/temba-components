    ...
    updated(changedProperties) {
        ...
        if (changedProperties.has('data')) {
            if (!changedProperties.get('data')) {
                const badges = this.shadowRoot.querySelector('.badges');
                new ResizeObserver(debounce(this.handleResized.bind(this), 200)).observe(badges);
            }
        }
    }
    render() {
...
], ContactBadges.prototype, "hasMore", void 0);
__decorate([
    property({ type: Boolean })
], ContactBadges.prototype, "expanded", void 0);
//# sourceMappingURL=ContactBadges.js.map